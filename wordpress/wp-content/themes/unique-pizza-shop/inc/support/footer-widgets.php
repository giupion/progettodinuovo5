 ...
 * @since 1.0.0
 */
class Unique_Pizza_Shop_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'unique_pizza_shop';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'unique-pizza-shop' ), $i ),
...
// Initialize.
$unique_pizza_shop_Footer_Widgets = new unique_pizza_shop_Footer_Widgets();