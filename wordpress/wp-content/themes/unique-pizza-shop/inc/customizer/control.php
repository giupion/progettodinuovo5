 ...
 */
class Unique_Pizza_Shop_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-pizza-shop' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-pizza-shop-customize-controls' );
		wp_enqueue_script( 'unique-pizza-shop-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Pizza_Shop_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
