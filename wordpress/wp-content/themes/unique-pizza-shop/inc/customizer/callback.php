...
if ( ! function_exists( 'unique_pizza_shop_is_image_in_archive_active' ) ) :
	 ...
	 */
	function unique_pizza_shop_is_image_in_archive_active( $control ) {
...
if ( ! function_exists( 'unique_pizza_shop_is_image_in_single_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function unique_pizza_shop_is_image_in_single_active( $control ) {
